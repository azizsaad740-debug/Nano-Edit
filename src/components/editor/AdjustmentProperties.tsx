...
import type { Layer, AdjustmentLayerData, HslAdjustment, EditState, Point } from "@/hooks/useEditorState";
...
import { initialCurvesState, initialHslAdjustment } from "@/hooks/useEditorState";
