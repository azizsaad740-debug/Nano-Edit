    ...
    <div className="flex items-center justify-between h-10 px-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="flex items-center space-x-2">
        ...
        <Button 
          variant="ghost" 
          size="sm" 
          onClick={toggleSmartObjectEditor} 
        ...
        {/* Panel Toggles */}
        <Button variant="ghost" size="sm" onClick={toggleLayerPanel} title="Layers Panel">
          <LayersIcon className="h-4 w-4" />
        </Button>
        <Button variant="ghost" size="sm" onClick={toggleHistoryPanel} title="History Panel">
          <HistoryIcon className="h-4 w-4" />
        </Button>
        <Button variant="ghost" size="sm" onClick={togglePresetManager} title="Preset Manager">
          <Image className="h-4 w-4" />
        </Button>
        <Button variant="ghost" size="sm" onClick={toggleSettingsPanel} title="Settings">
